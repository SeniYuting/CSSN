...
public class StuScorePanel extends JPanel {
	...
	public StuScorePanel(final String stuNO) {
		...
		setLayout(null);
		final String[] jp5title = { "编号", "课程号", "课程名称", "任课教师" };
...
//		OKButton.setForeground(Color.BLUE);
		...
		final JLabel allLabel = new JLabel("  查看全科成绩");
...
//		allLabel.setIcon(icon);
		allLabel.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				Object[][] info = new Object[voList.size()][3];
		...
		checkButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (myCourse.size() > 0) {
					...
					Object[][] selectedCourse = trans.shortTransform(myCourse);
